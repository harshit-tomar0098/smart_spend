...
const predictionData = [
  ...
  { name: 'Week 2', actual: 300, predicted: 350 },
  { name: 'Week 3', actual: 550, predicted: 500 },
  { name: 'Week 4', actual: null, predicted: 480 }, // Future prediction
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-white mb-6">Expense Forecast (Next 7 Days)</h3>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-6 shadow-lg text-white relative overflow-hidden">
             ...
             <p className="text-3xl font-bold relative z-10 mb-1">$3,450.00</p>
             <p className="text-blue-100 text-sm relative z-10">+$250 higher than last month</p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
                 ...
                 <div>
                   <h4 className="font-medium text-slate-800 dark:text-white text-sm">Subscription Alert</h4>
                   <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">You have 3 unused subscriptions costing $45/mo. Consider canceling them.</p>
                 </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
                 ...
                 <div>
                   <h4 className="font-medium text-slate-800 dark:text-white text-sm">Savings Opportunity</h4>
                   <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">If you reduce dining out by 15%, you can hit your vacation goal 2 months early.</p>
                 </div>
              </div>
            </div>
            <button className="w-full mt-4 flex items-center justify-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
